...
export const PayPalButton =() =>{
  ...
  const navigate = useNavigate();
    ...
    const handlePayment = async (e: any) => {
        ...
        try {
          const res = await axios.get('https://pay-pal-server-m9zd9or6r-sandip-kumar-yadavs-projects.vercel.app/payment');
    ...
    const checkPaymentStatus = async () => {
      try {
          ...
          if (payerId && paymentId) {
              const res = await axios.get(`https://pay-pal-server-m9zd9or6r-sandip-kumar-yadavs-projects.vercel.app/?PayerID=${payerId}&paymentId=${paymentId}`);
